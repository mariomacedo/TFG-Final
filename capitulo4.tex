...
O \textit{Score SUS} da aplicação e-TAPE foi de 78,75, o que indica um valor acima da média de referência de valor 68.0, relatada por \citeonline{sauro2015supr}.
...
por \citeonline{nielsen199510}, foi possível chegar as seguintes conclusões:
...
\end{table}
\par
Sendo assim, analisando os critérios de qualidade propostos por \citeonline{nielsen199510}, foi possível chegar às seguintes conclusões:
\par
