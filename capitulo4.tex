...
\par
Em \citeonline{sauro2015supr}, os autores definem 68,0 como um valor de referência para as aplicações avaliadas, ou seja, as aplicações cujo \textit{Score SUS} for maior ou igual ao valor de referência podem ser consideradas adequadas em relação à usabilidade.
